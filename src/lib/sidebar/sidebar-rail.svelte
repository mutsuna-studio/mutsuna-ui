...
let {
  ...
  ...restProps
}: WithElementRef<HTMLAttributes<HTMLButtonElement>, HTMLButtonElement> & { hideHeaderSeam?: boolean } = $props();
...
<button
	...
	class={cn(
		...
		hideHeaderSeam && "after:top-14 group-data-[collapsible=icon]:after:top-10",
