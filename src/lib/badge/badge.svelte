...
export const badgeVariants = tv({
  ...
  variants: {
    variant: {
      ...
      destructive:
        "bg-destructive/10 [a]:hover:bg-destructive/10 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 text-destructive dark:bg-destructive/20",
